...
import com.example.musicplayer.databinding.BottomSheetBinding
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    //현재 재생되고 있는 음악 리스트, 현재 화면에 보여지는 음악 리스트, 검색 결과 음악 리스트를 분리
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.menuSongs -> {
                binding.collapssingToolbarLayout.title = "음악"
                getFilteredMusicList(null, Type.ALL)
                binding.drawerLayout.closeDrawers()
            }

            R.id.menuFavorite -> {
                binding.collapssingToolbarLayout.title = "즐겨찾기"
        ...
        searchView.setOnQueryTextListener(object: SearchView.OnQueryTextListener{
            ...
            override fun onQueryTextChange(query: String?): Boolean {
                if (!query.isNullOrBlank()) {
                    ...
                    //검색 텍스트가 비었을 경우 검색 하기 전의 리스트 출력
    ...
    fun bottomSheetUpdate(music: Music){
        ...
        if (bitmapLarge != null && bitmapSmall != null) {
            ...
            bottomSheetBinding.ivAlbumImageLarge.setImageResource(R.drawable.itunes)
            bottomSheetBinding.bottomSheetSmall.ivAlbumImageSmall.setImageResource(R.drawable.itunes)
        }
    ...
    fun musicStop() {
        ...
        bottomSheetBinding.bottomSheetSmall.ivPlaySmall.setImageResource(R.drawable.play)
        bottomSheetBinding.ivPlayLarge.setImageResource(R.drawable.play)
    }
    ...
    fun musicStart() {
        mediaPlayer?.start()
        isPlaying = true
        bottomSheetBinding.bottomSheetSmall.ivPlaySmall.setImageResource(R.drawable.pause)
        bottomSheetBinding.ivPlayLarge.setImageResource(R.drawable.pause)
